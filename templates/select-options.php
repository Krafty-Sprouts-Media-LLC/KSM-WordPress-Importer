...
<form action="<?php echo esc_url( $this->get_url( 2 ) ) ?>" method="post">
	...
	<?php if ( ! empty( $data->users ) ) : ?>
		...
		<div class="wxr-card">
			...
			<?php if ( $this->allow_create_users() ) : ?>
				<p style="color:#646970;font-size:13px;"><?php printf(
	...
	<?php if ( $this->allow_fetch_attachments() ) : ?>
		...
		<div class="wxr-card">
			...
			<p style="color:#646970;font-size:13px;"><?php esc_html_e( 'Leave unchecked for local/offline imports — attachments can be imported separately.', 'wordpress-importer' ) ?></p>
		</div>
	...
	<?php submit_button( __( 'Run Import', 'wordpress-importer' ), 'primary large' ) ?>
